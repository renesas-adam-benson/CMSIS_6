...
#ifndef ARM_GIC_V30_H
#define ARM_GIC_V30_H
...
typedef struct
{
  __IM  uint32_t CTLR;                 /*!< \brief  Offset: 0x000 (R/ ) Redistributor Control Register */
  ...
  __OM  uint64_t SETLPIR;              /*!< \brief  Offset: 0x040 ( /W) Set LPI Pending Register */
  __OM  uint64_t CLRLPIR;              /*!< \brief  Offset: 0x048 ( /W) Clear LPI Pending Register */
  ...
  __IM  uint64_t SYNCR;                /*!< \brief  Offset: 0x0C0 (R/ ) Redistributor Synchronize Register */
}  GICRedistributor_Type;

/** \brief  Structure type to access the Generic Interrupt Controller SGI and PPI Redistributor (GICR_SGI_PPI).
*/
typedef struct
{
  ...
  __IOM uint32_t ISPENDR0;             /*!< \brief  Offset: 0x200 (R/W) Interrupt Set-Pending Register 0 */
        RESERVED(4[31], uint32_t)
  __IOM uint32_t ICPENDR0;             /*!< \brief  Offset: 0x280 (R/W) Interrupt Clear-Pending Register 0 */
  ...
  __IOM uint32_t IPRIORITYR[8];        /*!< \brief  Offset: 0x400 (R/W) Interrupt Priority Registers */
        RESERVED(8[504], uint32_t)
  __IOM uint32_t ICFGR0;               /*!< \brief  Offset: 0xC00 (R/W) SGI Configuration Register */
  __IOM uint32_t ICFGR1;               /*!< \brief  Offset: 0xC04 (R/W) PPI Configuration Register */
        RESERVED(9[63], uint32_t)
...
#define GICRedistributor_SGI_PPI  ((GICRedistributor_SGI_PPI_Type    *)     GIC_REDISTRIBUTOR_SGI_PPI_BASE) /*!< \brief GIC SGI/PPI Redistributor register set access pointer */
